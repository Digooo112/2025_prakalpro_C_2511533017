...
public class ClassUtama {
	...
	public static void main(String[] args) { 
        ...
        System.out.print("Masukkan PIN (6 digit): ");         int pin = scanner.nextInt(); 
         
        Akun_2511533017 akun = new Akun_2511533017(username, password, email, pin); 
...
String.valueOf(akun.getPinAngka()) + "10"); 
        } 
